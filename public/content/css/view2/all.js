/*1386206150,177613590,JIT Construction: v1033590,es_LA*/
...
try {
    window.FB || (function (window) {
        ...
        var ES5 = function () {
            ...
            __d("ES5Object", [], function (a, b, c, d, e, f) {
                ...
                g.keys = function (h) {
                    ...
                    var l = !({toString: true}).propertyIsEnumerable('toString'),
             ...
             */__d("JSON3", [], function (a, b, c, d, e, f) {
                (function () {
                    var g = {}.toString, h, i, j, k = e.exports = {},
                        l = '{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}', m, n, o, p, q, r, s, t, u, v, w, x, y,
                        z, aa, ba = new Date(-3509827334573292), ca, da, ea;
                    try {
            ...
            __d("ES5", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3"], function (a, b, c, d, e, f) {
                var g = b('ES5ArrayPrototype'), h = b('ES5FunctionPrototype'), i = b('ES5StringPrototype'),
                    j = b('ES5Array'), k = b('ES5Object'), l = b('ES5Date'), m = b('JSON3'), n = Array.prototype.slice,
                    o = Object.prototype.toString, p = {'JSON.stringify': m.stringify, 'JSON.parse': m.parse},
                    q = {array: g, 'function': h, string: i, Object: k, Array: j, Date: l};
                for (var r in q) {
                ...
                function w(x, y, z) {
                    var aa = n.call(arguments, 3), ba = z ? /\s(.*)\]/.exec(o.call(x).toLowerCase())[1] : x,
                        ca = p[ba + '.' + y] || x[y];
        ...
        __d("sdk.RuntimeConfig", [], {"locale": "es_LA", "rtl": false});
        __d("XDConfig", [], {
            "XdUrl": "connect\/xd_arbiter.php?version=28",
            "Flash": {"path": "https:\/\/connect.facebook.net\/rsrc.php\/v1\/yS\/r\/NoZWYE2GRkt.swf"},
            "useCdn": true
        });
        __d("UrlMapConfig", [], {
        ...
        __d("sdk.Runtime", ["sdk.Model", "copyProperties", "sdk.RuntimeConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.Model'), h = c('sdk.RuntimeConfig'), i = b('copyProperties'),
                j = {UNKNOWN: 0, PAGETAB: 1, CANVAS: 2, PLATFORM: 4}, k = new g({
                    AccessToken: '',
                    ClientID: '',
        ...
        __d("URL", ["Assert", "copyProperties", "QueryString", "Log"], function (a, b, c, d, e, f) {
            var g = b('Assert'), h = b('copyProperties'), i = b('QueryString'), j = b('Log'),
                k = new RegExp('(' + '(((\\w+):)?//)' + '(.*?@)?' + '([^~/?#:]+)' + '(:(\\d+))?' + ')?' + '([^\\?$#]+)?' + '(\\?([^$#]+))?' + '(#([^$]+))?'),
                l = /[\0\\]/, m = /[^\w\-\.,;\/?:@=&%#$~+!*'\[\]()]+/g, n = /^[a-z0-9.][a-z0-9\-\.]+[a-z0-9.]$/,
                o = /\.facebook\.com$/;
            ...
            h(p.prototype, {
                constructor: p, getProtocol: function () {
        ...
        __d("sdk.RPC", ["Assert", "JSONRPC", "Queue"], function (a, b, c, d, e, f) {
            var g = b('Assert'), h = b('JSONRPC'), i = b('Queue'), j = new i(), k = new h(function (m) {
                ...
                local: k.local, remote: k.remote, stub: ES5(k.stub, 'bind', true, k), setInQueue: function (m) {
                    g.isInstanceOf(i, m);
                    m.start(function (n) {
                        k.read(n);
                    });
        ...
        __d("Flash", ["DOMWrapper", "QueryString", "UserAgent", "copyProperties", "guid", "htmlSpecialChars"], function (a, b, c, d, e, f) {
            var g = b('DOMWrapper'), h = b('QueryString'), i = b('UserAgent'), j = b('copyProperties'), k = b('guid'),
                l = b('htmlSpecialChars'), m = {}, n, o = g.getWindow().document;
            ...
            var t = {
                embed: function (u, v, w, x) {
                    var y = k();
                    u = l(u).replace(/&amp;/g, '&');
                    w = j({allowscriptaccess: 'always', flashvars: x, movie: u}, w || {});
                    ...
                    var u = 'Shockwave Flash', v = 'application/x-shockwave-flash', w = 'ShockwaveFlash.ShockwaveFlash',
                        x;
        ...
        __d("XDM", ["DOMEventListener", "DOMWrapper", "emptyFunction", "Flash", "GlobalCallback", "guid", "Log", "UserAgent", "wrapFunction"], function (a, b, c, d, e, f) {
            var g = b('DOMEventListener'), h = b('DOMWrapper'), i = b('emptyFunction'), j = b('Flash'),
                k = b('GlobalCallback'), l = b('guid'), m = b('Log'), n = b('UserAgent'), o = b('wrapFunction'), p = {},
                q = {transports: []}, r = h.getWindow();
        ...
        __d("sdk.XD", ["sdk.Content", "sdk.createIframe", "sdk.feature", "sdk.Event", "guid", "Log", "QueryString", "Queue", "resolveURI", "resolveWindow", "sdk.RPC", "sdk.Runtime", "UrlMap", "URL", "wrapFunction", "XDM", "XDConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.Content'), h = b('sdk.createIframe'), i = b('sdk.feature'), j = b('sdk.Event'),
                k = b('guid'), l = b('Log'), m = b('QueryString'), n = b('Queue'), o = b('resolveURI'),
                p = b('resolveWindow'), q = b('sdk.RPC'), r = b('sdk.Runtime'), s = b('UrlMap'), t = b('URL'),
                u = b('wrapFunction'), v = c('XDConfig'), w = b('XDM'), x = new n(), y = new n(), z = new n(), aa, ba,
                ca = k(), da = k(), ea = location.protocol + '//' + location.host, fa, ga = false,
                ha = 'Facebook Cross Domain Communication Frame', ia = {}, ja = new n();
            q.setInQueue(ja);
            ...
            function oa(qa, ra) {
                ...
                var ta = g.appendHidden(document.createElement('div')), ua = i('kill_fragment') ? ['fragment'] : null,
                    va = w.create({
                        blacklist: ua,
                        root: ta,
                        channel: da,
        ...
        __d("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function (a, b, c, d, e, f) {
            var g = b('sdk.Cookie'), h = b('copyProperties'), i = b('sdk.createIframe'), j = b('DOMWrapper'),
                k = b('sdk.feature'), l = b('sdk.getContextType'), m = b('guid'), n = b('sdk.Impressions'),
                o = b('Log'), p = b('ObservableMixin'), q = b('QueryString'), r = b('sdk.Runtime'),
                s = b('sdk.SignedRequest'), t = b('UrlMap'), u = b('URL'), v = b('sdk.XD'), w, x, y = new p();
            ...
            function z(fa, ga) {
                ...
                var ka = r.getLoginStatus(),
                    la = (ka === 'unknown' && fa) || (r.getUseCookie() && r.getCookieUserID() !== ia), ma = ha && !fa,
                    na = fa && ha && ha != ia, oa = fa != w, pa = ga != (ka || 'unknown');
                r.setLoginStatus(ga);
        ...
        __d("sdk.ErrorHandling", ["sdk.feature", "ManagedError", "sdk.Runtime", "sdk.Scribe", "UserAgent", "wrapFunction"], function (a, b, c, d, e, f) {
            var g = b('sdk.feature'), h = b('ManagedError'), i = b('sdk.Runtime'), j = b('sdk.Scribe'),
                k = b('UserAgent'), l = b('wrapFunction'), m = g('error_handling', false), n = '';
        ...
        __d("FB", ["sdk.Auth", "copyProperties", "dotAccess", "sdk.domReady", "sdk.DOM", "sdk.ErrorHandling", "sdk.Content", "DOMWrapper", "GlobalCallback", "sdk.Insights", "Log", "sdk.Runtime", "sdk.Scribe", "CssConfig", "SDKConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.Auth'), h = b('copyProperties'), i = c('CssConfig'), j = b('dotAccess'),
                k = b('sdk.domReady'), l = b('sdk.DOM'), m = b('sdk.ErrorHandling'), n = b('sdk.Content'),
                o = b('DOMWrapper'), p = b('GlobalCallback'), q = b('sdk.Insights'), r = b('Log'), s = b('sdk.Runtime'),
                t = b('sdk.Scribe'), u = c('SDKConfig'), v, w, x = j(u, 'api.mode'), y = {};
            v = window.FB = {};
            var z = {};
            r.level = 1;
                ...
                switch (ha) {
                    ...
                    default:
                        return m.guard(function () {
                            ...
                            var ja = ES5(Array.prototype.slice.call(arguments), 'map', true, ia), ka = da.apply(ga, ja),
                                la, ma = true;
        ...
        __d("FlashRequest", ["DOMWrapper", "Flash", "GlobalCallback", "QueryString", "Queue"], function (a, b, c, d, e, f) {
            var g = b('DOMWrapper'), h = b('Flash'), i = b('GlobalCallback'), j = b('QueryString'), k = b('Queue'), l,
                m = {}, n, o;
        ...
        __d("ApiClient", ["ArgumentError", "Assert", "copyProperties", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "UrlMap", "URL", "ApiClientConfig"], function (a, b, c, d, e, f) {
            var g = b('ArgumentError'), h = b('Assert'), i = b('copyProperties'), j = b('CORSRequest'),
                k = b('FlashRequest'), l = b('flattenObject'), m = b('JSONPRequest'), n = b('Log'),
                o = b('ObservableMixin'), p = b('sprintf'), q = b('UrlMap'), r = b('URL'), s = b('ApiClientConfig'), t,
                u, v, w = {get: true, post: true, 'delete': true, put: true}, x = {
                    fql_query: true,
                    fql_multiquery: true,
                    friends_get: true,
            ...
            function aa(da) {
                ...
                var ha = (fa.string || 'get').toLowerCase(), ia = i(fa.object || {}, ea.getParsedSearch()),
                    ja = fa['function'];
            ...
            function ba(da, ea) {
                ...
                da.api_key = u;
                var ga = fa in x ? 'api_read' : 'api', ha = q.resolve(ga) + '/restserver.php',
        ...
        __d("sdk.Dialog", ["sdk.Canvas.Environment", "sdk.Content", "sdk.DOM", "DOMEventListener", "sdk.Intl", "ObservableMixin", "sdk.Runtime", "Type", "UserAgent"], function (a, b, c, d, e, f) {
            var g = b('sdk.Canvas.Environment'), h = b('sdk.Content'), i = b('sdk.DOM'), j = b('DOMEventListener'),
                k = b('sdk.Intl'), l = b('ObservableMixin'), m = b('sdk.Runtime'), n = b('Type'), o = b('UserAgent'),
                p = n.extend({
                    ...
                    _createMobileLoader: function () {
                        var r = o.nativeApp() ? '' : ('<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + k.tx._("Cancelar") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + k.tx._("Cargando...") + '</div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>');
                        return q.create({
                    ...
                    _centerActive: function (r) {
                        var s = q._active;
                        if (!s) return;
                        var t = i.getViewportInfo(), u = parseInt(s.offsetWidth, 10), v = parseInt(s.offsetHeight, 10),
                            w = t.scrollLeft + (t.width - u) / 2, x = (t.height - v) / 2.5;
                        if (w < x) x = w;
        ...
        __d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "copyProperties", "sdk.Dialog", "sdk.DOM", "sdk.Event", "flattenObject", "sdk.Frictionless", "sdk.getContextType", "guid", "insertIframe", "Log", "sdk.Native", "QueryString", "resolveURI", "sdk.RPC", "sdk.Runtime", "UrlMap", "UserAgent", "sdk.XD", "SDKConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.Auth'), h = b('sdk.Content'), i = b('copyProperties'), j = b('sdk.Dialog'), k = b('sdk.DOM'),
                l = b('sdk.Event'), m = b('flattenObject'), n = b('sdk.Frictionless'), o = b('sdk.getContextType'),
                p = b('guid'), q = b('insertIframe'), r = b('Log'), s = b('sdk.Native'), t = b('QueryString'),
                u = b('resolveURI'), v = b('sdk.RPC'), w = b('sdk.Runtime'), x = c('SDKConfig'), y = b('UrlMap'),
                z = b('UserAgent'), aa = b('sdk.XD'), ba = {
                    ...
                    'permissions.oauth': {
                        url: 'dialog/oauth',
                        size: {width: (z.mobile() ? null : 475), height: (z.mobile() ? null : 183)},
                        transform: function (ea) {
                            if (!w.getClientID()) {
                    ...
                    prepareCall: function (ea, fa) {
                        var ga = ea.method.toLowerCase(), ha = i({}, da.Methods[ga]), ia = p(),
                    ...
                    popup: function (ea) {
                        var fa = typeof window.screenX != 'undefined' ? window.screenX : window.screenLeft,
                            ...
                            ja = z.mobile() ? null : ea.size.width, ka = z.mobile() ? null : ea.size.height,
                            la = (fa < 0) ? window.screen.width + fa : fa, ma = parseInt(la + ((ha - ja) / 2), 10),
                            na = parseInt(ga + ((ia - ka) / 2.5), 10), oa = [];
        ...
        __d("sdk.ui", ["Assert", "copyProperties", "sdk.feature", "sdk.Impressions", "Log", "sdk.UIServer"], function (a, b, c, d, e, f) {
            var g = b('Assert'), h = b('copyProperties'), i = b('sdk.feature'), j = b('sdk.Impressions'), k = b('Log'),
                l = b('sdk.UIServer');
        ...
        __d("legacy:fb.auth", ["sdk.Auth", "sdk.Cookie", "copyProperties", "sdk.Event", "FB", "Log", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui"], function (a, b, c, d) {
            var e = b('sdk.Auth'), f = b('sdk.Cookie'), g = b('copyProperties'), h = b('sdk.Event'), i = b('FB'),
                j = b('Log'), k = b('sdk.Runtime'), l = b('sdk.SignedRequest'), m = b('sdk.ui');
            i.provide('', {
        ...
        __d("sdk.Canvas.Plugin", ["sdk.api", "sdk.RPC", "Log", "sdk.Runtime", "createArrayFrom"], function (a, b, c, d, e, f) {
            var g = b('sdk.api'), h = b('sdk.RPC'), i = b('Log'), j = b('sdk.Runtime'), k = b('createArrayFrom'),
                l = 'CLSID:D27CDB6E-AE6D-11CF-96B8-444553540000', m = 'CLSID:444785F1-DE89-4295-863A-D46C3A781394',
                n = null;
        ...
        __d("sdk.Canvas.IframeHandling", ["DOMWrapper", "sdk.RPC"], function (a, b, c, d, e, f) {
            ...
            function k() {
                var o = g.getWindow().document, p = o.body, q = o.documentElement, r = Math.max(p.offsetTop, 0),
                    s = Math.max(q.offsetTop, 0), t = p.scrollHeight + r, u = p.offsetHeight + r,
                    v = q.scrollHeight + s, w = q.offsetHeight + s;
        ...
        __d("legacy:fb.canvas", ["Assert", "sdk.Canvas.Environment", "sdk.Event", "FB", "sdk.Canvas.Plugin", "sdk.Canvas.IframeHandling", "Log", "sdk.Canvas.Navigation", "sdk.Runtime", "sdk.Canvas.Tti"], function (a, b, c, d) {
            var e = b('Assert'), f = b('sdk.Canvas.Environment'), g = b('sdk.Event'), h = b('FB'),
                i = b('sdk.Canvas.Plugin'), j = b('sdk.Canvas.IframeHandling'), k = b('Log'),
                l = b('sdk.Canvas.Navigation'), m = b('sdk.Runtime'), n = b('sdk.Canvas.Tti');
            h.provide('Canvas', {
                setSize: function (o) {
        ...
        __d("sdk.Canvas.Prefetcher", ["sdk.api", "createArrayFrom", "sdk.Runtime", "CanvasPrefetcherConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.api'), h = b('createArrayFrom'), i = c('CanvasPrefetcherConfig'), j = b('sdk.Runtime'),
                k = {AUTOMATIC: 0, MANUAL: 1}, l = i.sampleRate, m = i.blacklist, n = k.AUTOMATIC, o = [];
        ...
        __d("sdk.Data", ["sdk.api", "sdk.ErrorHandling", "mergeArrays", "sdk.Query", "safeEval", "sdk.Waitable"], function (a, b, c, d, e, f) {
            var g = b('sdk.api'), h = b('sdk.ErrorHandling'), i = b('mergeArrays'), j = b('sdk.Query'),
                k = b('safeEval'), l = b('sdk.Waitable'), m = {
                    query: function (n, o) {
        ...
        __d("sdk.init", ["sdk.Cookie", "copyProperties", "createArrayFrom", "sdk.ErrorHandling", "sdk.Event", "Log", "QueryString", "sdk.Runtime"], function (a, b, c, d, e, f) {
            var g = b('sdk.Cookie'), h = b('copyProperties'), i = b('createArrayFrom'), j = b('sdk.ErrorHandling'),
                k = b('sdk.Event'), l = b('Log'), m = b('QueryString'), n = b('sdk.Runtime');
            ...
            function p(q) {
                ...
                q = h({logging: true, status: true}, q || {});
        ...
        __d("legacy:fb.pay", ["FB", "copyProperties", "sdk.Runtime", "sdk.UIServer", "sdk.XD"], function (a, b, c, d) {
            b('FB');
            var e = b('copyProperties'), f = b('sdk.Runtime'), g = b('sdk.UIServer'), h = b('sdk.XD'),
                i = {error_code: 1383001, error_message: 'An unknown error caused the dialog to be closed'},
                j = function (k) {
                    return function (l) {
            ...
            e(g.Methods, {
                'pay.prompt': {
                    ...
                    size: {width: 555, height: 120}, connectDisplay: 'popup', transform: function (k) {
                        k.cb = j(k.cb);
        ...
        __d("XFBML", ["Assert", "copyProperties", "createArrayFrom", "sdk.DOM", "sdk.feature", "sdk.Impressions", "Log", "ObservableMixin", "runOnce", "UserAgent"], function (a, b, c, d, e, f) {
            var g = b('Assert'), h = b('copyProperties'), i = b('createArrayFrom'), j = b('sdk.DOM'),
                k = b('sdk.feature'), l = b('sdk.Impressions'), m = b('Log'), n = b('ObservableMixin'),
                o = b('runOnce'), p = b('UserAgent'), q = {}, r = {}, s = 0, t = new n();
            ...
            if (k('log_tag_count')) {
                var ba = function (ca, da) {
                    ...
                    setTimeout(ES5(l.log, 'bind', true, null, 102, {tag_count: da}), 5000);
                };
        ...
        __d("PluginPipe", ["sdk.Content", "copyProperties", "sdk.feature", "guid", "insertIframe", "Miny", "ObservableMixin", "sdk.Runtime", "UrlMap", "UserAgent", "XFBML", "PluginPipeConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.Content'), h = b('copyProperties'), i = b('sdk.feature'), j = b('guid'),
                k = b('insertIframe'), l = b('Miny'), m = b('ObservableMixin'), n = c('PluginPipeConfig'),
                o = b('sdk.Runtime'), p = b('UrlMap'), q = b('UserAgent'), r = b('XFBML'), s = new m(), t = n.threshold,
                u = [];
        ...
        __d("IframePlugin", ["sdk.Auth", "sdk.createIframe", "copyProperties", "sdk.DOM", "sdk.Event", "guid", "Log", "ObservableMixin", "PluginPipe", "QueryString", "resolveURI", "sdk.Runtime", "Type", "UrlMap", "UserAgent", "sdk.XD"], function (a, b, c, d, e, f) {
            var g = b('sdk.Auth'), h = b('sdk.createIframe'), i = b('copyProperties'), j = b('sdk.DOM'),
                k = b('sdk.Event'), l = b('guid'), m = b('Log'), n = b('ObservableMixin'), o = b('PluginPipe'),
                p = b('QueryString'), q = b('resolveURI'), r = b('sdk.Runtime'), s = b('Type'), t = b('UrlMap'),
                u = b('UserAgent'), v = b('sdk.XD'),
                w = {skin: 'string', font: 'string', width: 'px', height: 'px', ref: 'string', color_scheme: 'string'};
            ...
            function y(ea) {
                return function (fa) {
                    var ga = {width: fa.width, height: fa.height, pluginID: ea};
            ...
            var da = s.extend({
                constructor: function (ea, fa, ga, ha) {
                    ...
                    var ja = r.getSecure() || window.location.protocol == 'https:',
                        ka = t.resolve('www', ja) + '/plugins/' + ga + '.php?', la = {};
                    ...
                    this.subscribe('xd.verify', function (pa) {
                        v.sendToFacebook(na, {method: 'xd/verify', params: ES5('JSON', 'stringify', false, pa.token)});
                    });
        ...
        __d("sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "copyProperties", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], function (a, b, c, d, e, f) {
            var g = b('sdk.Arbiter'), h = b('sdk.Auth'), i = b('sdk.Content'), j = b('copyProperties'),
                k = b('sdk.DOM'), l = b('sdk.Event'), m = b('sdk.XFBML.Element'), n = b('guid'), o = b('insertIframe'),
                p = b('QueryString'), q = b('sdk.Runtime'), r = b('sdk.ui'), s = b('UrlMap'), t = b('sdk.XD'),
                u = m.extend({
                    _iframeName: null,
                    _showLoader: true,
                    ...
                    _updateIframeZIndex: function () {
                        var y = this.dom.getElementsByTagName('span')[0], z = this.getIframeNode(),
                    ...
                    _repositionIframe: function (y) {
                        var z = this.getIframeNode(), aa = parseInt(k.getStyle(z, 'width'), 10),
                            ba = k.getPosition(z).x, ca = k.getViewportInfo().width, da = parseInt(y.width, 10);
                        if (ba + da > ca && ba > da) {
        ...
        __d("sdk.XFBML.Comments", ["sdk.Event", "sdk.XFBML.IframeWidget", "QueryString", "sdk.Runtime", "UrlMap", "UserAgent", "SDKConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.Event'), h = b('sdk.XFBML.IframeWidget'), i = b('QueryString'), j = b('sdk.Runtime'),
                k = c('SDKConfig'), l = b('UrlMap'), m = b('UserAgent'), n = h.extend({
        ...
        __d("sdk.XFBML.ConnectBar", ["sdk.Anim", "sdk.api", "sdk.Auth", "createArrayFrom", "sdk.Data", "sdk.DOM", "sdk.XFBML.Element", "escapeHTML", "sdk.Event", "format", "sdk.Helper", "sdk.Insights", "sdk.Intl", "sdk.Runtime", "UrlMap", "UserAgent", "ConnectBarConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.Anim'), h = b('sdk.api'), i = b('sdk.Auth'), j = b('createArrayFrom'),
                k = c('ConnectBarConfig'), l = b('sdk.Data'), m = b('sdk.DOM'), n = b('sdk.XFBML.Element'),
                o = b('escapeHTML'), p = b('sdk.Event'), q = b('format'), r = b('sdk.Helper'), s = b('sdk.Insights'),
                t = b('sdk.Intl'), u = b('sdk.Runtime'), v = b('UrlMap'), w = b('UserAgent'), x = n.extend({
                    _initialHeight: null,
                    _initTopMargin: 0,
                    ...
                    _renderConnectBar: function (y) {
                        ...
                        m.html(z, q('<div class="fb_buttons">' + '<a href="#" class="fb_bar_close">' + '<img src="{1}" alt="{2}" title="{2}"/>' + '</a>' + '</div>' + '<a href="{7}" class="fb_profile" target="_blank">' + '<img src="{3}" alt="{4}" title="{4}"/>' + '</a>' + '{5}' + ' <span>' + '<a href="{8}" class="fb_learn_more" target="_blank">{6}</a> &ndash; ' + '<a href="#" class="fb_no_thanks">{0}</a>' + '</span>', t.tx._("No, gracias"), v.resolve('fbcdn') + '/' + k.imgs.buttonUrl, t.tx._("Cerrar"), y[this._picFieldName] || v.resolve('fbcdn') + '/' + k.imgs.missingProfileUrl, o(y.first_name), t.tx._("Hola, {firstName}. \u003Cstrong>{siteName}\u003C\/strong> est\u00e1 usando Facebook para personalizar tu experiencia.", {
                            firstName: o(y.first_name),
                            siteName: o(y.site_name)
                        }), t.tx._("M\u00e1s informaci\u00f3n"), y.profile_url, v.resolve('www') + '/sitetour/connect.php'));
        ...
        __d("sdk.XFBML.EdgeWidget", ["sdk.Event", "sdk.XFBML.IframeWidget", "sdk.XFBML.EdgeCommentWidget", "sdk.DOM", "sdk.Helper", "sdk.Runtime"], function (a, b, c, d, e, f) {
            var g = b('sdk.Event'), h = b('sdk.XFBML.IframeWidget'), i = b('sdk.XFBML.EdgeCommentWidget'),
                j = b('sdk.DOM'), k = b('sdk.Helper'), l = b('sdk.Runtime'), m = h.extend({
                    _visibleAfter: 'immediate', _showLoader: false, _rootPadding: null, setupAndValidate: function () {
                        ...
                        var n = this._getLayout(), o = this._shouldShowFaces() ? 'show' : 'hide',
                            p = this._getBoolAttribute('send') || this._getBoolAttribute('share'), q = 65 + (p ? 25 : 0),
                            r = {
                                standard: {show: 80, hide: 35},
                                box_count: {show: q, hide: q},
                                button_count: {show: 21, hide: 21},
                                simple: {show: 20, hide: 20}
                            };
                        return r[n][o];
                    }, _getWidgetWidth: function () {
                        var n = this._getLayout(), o = this._getBoolAttribute('send') || this._getBoolAttribute('share'),
                            p = this._shouldShowFaces() ? 'show' : 'hide',
                            q = (this.getAttribute('action') === 'recommend'), r = (q ? 265 : 225) + (o ? 60 : 0),
                            s = (q ? 130 : 90) + (o ? 60 : 0), t = this.getAttribute('action') === 'recommend' ? 100 : 55,
                            u = this.getAttribute('action') === 'recommend' ? 90 : 50, v = {
                                standard: {show: 450, hide: 450},
                                box_count: {show: t, hide: t},
                                button_count: {show: s, hide: s},
                                simple: {show: u, hide: u}
                            }, w = v[n][p], x = this._getPxAttribute('width', w), y = {
                                standard: {min: r, max: 900},
                                box_count: {min: t, max: 900},
                                button_count: {min: s, max: 900},
                                simple: {min: 49, max: 900}
                            };
                        if (x < y[n].min) {
                            x = y[n].min;
                        ...
                        var o = parseFloat(n['anchorPosition[x]']) + this._rootPadding.left, p = j.getPosition(this.dom).x,
                            q = this.dom.offsetWidth, r = j.getViewportInfo().width, s = parseFloat(n.width), t = false;
                        if (l.getRtl()) {
                            t = s < p;
        ...
        __d("sdk.XFBML.Name", ["copyProperties", "sdk.Data", "escapeHTML", "sdk.Event", "sdk.XFBML.Element", "sdk.Helper", "Log", "sdk.Runtime"], function (a, b, c, d, e, f) {
            var g = b('copyProperties'), h = b('sdk.Data'), i = b('escapeHTML'), j = b('sdk.Event'),
                k = b('sdk.XFBML.Element'), l = b('sdk.Helper'), m = b('Log'), n = b('sdk.Runtime'), o = k.extend({
                    process: function () {
                        g(this, {
        ...
        __d("sdk.XFBML.RecommendationsBar", ["sdk.Arbiter", "DOMEventListener", "sdk.Event", "sdk.XFBML.IframeWidget", "resolveURI", "sdk.Runtime"], function (a, b, c, d, e, f) {
            var g = b('sdk.Arbiter'), h = b('DOMEventListener'), i = b('sdk.Event'), j = b('sdk.XFBML.IframeWidget'),
                k = b('resolveURI'), l = b('sdk.Runtime'), m = j.extend({
                    getUrlBits: function () {
        ...
        __d("sdk.XFBML.Registration", ["sdk.Auth", "sdk.Helper", "sdk.XFBML.IframeWidget", "sdk.Runtime", "UrlMap"], function (a, b, c, d, e, f) {
            var g = b('sdk.Auth'), h = b('sdk.Helper'), i = b('sdk.XFBML.IframeWidget'), j = b('sdk.Runtime'),
                k = b('UrlMap'), l = i.extend({
        ...
        __d("legacy:fb.xfbml", ["Assert", "sdk.domReady", "sdk.Event", "FB", "IframePlugin", "PluginTags", "wrapFunction", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.ConnectBar", "sdk.XFBML.Like", "sdk.XFBML.LiveStream", "sdk.XFBML.LoginButton", "sdk.XFBML.Name", "sdk.XFBML.RecommendationsBar", "sdk.XFBML.Registration", "sdk.XFBML.SocialContext"], function (a, b, c, d) {
            var e = b('Assert'), f = b('sdk.domReady'), g = b('sdk.Event'), h = b('FB'), i = b('IframePlugin'),
                j = b('PluginTags'), k = b('wrapFunction'), l = b('XFBML'), m = {
