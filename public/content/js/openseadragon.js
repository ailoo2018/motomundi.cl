...
!function (e) {
    ...
    e.isPlainObject = function (t) {
        if (!t || "object" !== OpenSeadragon.type(t) || t.nodeType || e.isWindow(t))
            return !1;
...
!function ($) {
    ...
    $.extend($, {
        DEFAULT_SETTINGS: {
            ...
            navImages: {
                zoomIn: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/zoomin_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/zoomin_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/zoomin_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/zoomin_pressed.png"
                },
                zoomOut: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/zoomout_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/zoomout_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/zoomout_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/zoomout_pressed.png"
                },
                home: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/home_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/home_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/home_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/home_pressed.png"
                },
                fullpage: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/fullpage_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/fullpage_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/fullpage_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/fullpage_pressed.png"
                },
                rotateleft: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/rotateleft_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/rotateleft_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/rotateleft_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/rotateleft_pressed.png"
                },
                rotateright: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/rotateright_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/rotateright_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/rotateright_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/rotateright_pressed.png"
                },
                flip: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/flip_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/flip_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/flip_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/flip_pressed.png"
                },
                previous: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/previous_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/previous_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/previous_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/previous_pressed.png"
                },
                next: {
                    REST: "/templates/motomundidesktop/content/css/images/openseadragon/next_rest.png",
                    GROUP: "/templates/motomundidesktop/content/css/images/openseadragon/next_grouphover.png",
                    HOVER: "/templates/motomundidesktop/content/css/images/openseadragon/next_hover.png",
                    DOWN: "/templates/motomundidesktop/content/css/images/openseadragon/next_pressed.png"
                }
            },
            debugMode: !1,
        ...
        getElementOffset: function (e) {
            var t, i, n = (e = $.getElement(e)) && e.ownerDocument, o = {
                top: 0,
                left: 0
            };
            if (!n)
        ...
        makeAjaxRequest: function (e, t, i) {
            ...
            a.onreadystatechange = function () {
                if (4 == a.readyState) {
                    a.onreadystatechange = function () { }
                        ;
                    if (a.status >= 200 && a.status < 300 || 0 === a.status && "http:" !== s && "https:" !== s)
                        t(a);
                    else {
        ...
        jsonp: function (e) {
            var t, i = e.url, n = document.head || document.getElementsByTagName("head")[0] || document.documentElement, o = e.callbackName || "openseadragon" + $.now(), r = window[o], s = "$1" + o + "$2", a = e.param || "callback", l = e.callback;
            i = i.replace(/(\=)\?(&|$)|\?\?/i, s);
            i += (/\?/.test(i) ? "&" : "?") + a + "=" + o;
            window[o] = function (e) {
                if (r)
...
!function (e) {
    ...
    e.MouseTracker = function (n) {
        ...
        i[this.hash] = {
            click: function (t) {
                i = t,
                    r.clickHandler && e.cancelEvent(i);
                var i
            },
            dblclick: function (t) {
                i = t,
                    r.dblClickHandler && e.cancelEvent(i);
                var i
            },
            keydown: function (t) {
                !function (t, i) {
            ...
            mouseover: function (t) {
                !function (t, i) {
                    if ((i = e.getEvent(i)).currentTarget === i.relatedTarget || m(i.currentTarget, i.relatedTarget))
                        return;
                    v(t, i)
                }(r, t)
            },
            ...
            touchstart: function (i) {
                !function (i, n) {
                    var o, r, a, l, c = n.changedTouches.length, u = [], d = i.getActivePointersListByType("touch");
                    o = e.now();
    ...
    e.MouseTracker.prototype = {
        ...
        getActivePointersListByType: function (t) {
            var n, o, r = i[this.hash], s = r.activePointersLists.length;
            for (n = 0; n < s; n++)
                if (r.activePointersLists[n].type === t)
        ...
        getActivePointerCount: function () {
            var e, t = i[this.hash], n = t.activePointersLists.length, o = 0;
            for (e = 0; e < n; e++)
    ...
    e.MouseTracker.gesturePointVelocityTracker = function () {
        ...
        var r = function () {
            var i, o, r, s, a, l, h = t.length, c = e.now();
            s = c - n;
            n = c;
            for (i = 0; i < h; i++) {
    ...
    function n(t) {
        var n, o = i[t.hash], r = o.activePointersLists.length;
        for (n = 0; n < r; n++)
    ...
    function l(t) {
        var i;
        if (e.MouseTracker.unprefixedPointerEvents)
            i = t.pointerType;
        else
    ...
    function S(i, n) {
        var o, r, s, l, c = n.changedTouches.length, u = [];
        o = e.now();
        for (r = 0; r < c; r++)
            u.push({
                id: n.changedTouches[r].identifier,
    ...
    function E(t, i) {
        var n, o = i.changedTouches.length, r = [];
        for (n = 0; n < o; n++)
            r.push({
    ...
    function z(t, i, n) {
        var o, r, s, a = t.getActivePointersListByType(n[0].type), l = n.length;
        for (o = 0; o < l; o++) {
            r = n[o];
            if (s = a.getById(r.id)) {
                s.insideElement = !0;
    ...
    function H(t, n, o, r) {
        var s, a, l, h = i[t.hash], c = t.getActivePointersListByType(o[0].type), p = o.length;
        ...
        for (s = 0; s < p; s++) {
            ...
            if (1 === c.contacts)
                t.pressHandler && !1 === t.pressHandler({
                    eventSource: t,
                    pointerType: a.type,
    ...
    function L(t, n, o, r) {
        var s, a, l, h, c, p, g = i[t.hash], m = t.getActivePointersListByType(o[0].type), v = o.length, f = !1, w = !1;
    ...
    function F(t, n, o) {
        var r, s, a, l, h, p = i[t.hash], g = t.getActivePointersListByType(o[0].type), m = o.length;
...
!function (e) {
    ...
    e.Viewer = function (o) {
        ...
        this.addHandler("open-failed", function (t) {
            var i = e.getString("Error.OpenFailed", t.eventSource, t.message);
            h._showMessage(i)
        });
    ...
    e.extend(e.Viewer.prototype, e.EventSource.prototype, e.ControlDock.prototype, {
        ...
        setFullPage: function (i) {
            var n, o, r = document.body, s = r.style, a = document.documentElement.style, l = this;
            if (i == this.isFullPage())
                return this;
            var h = {
                fullPage: i,
                preventDefaultAction: !1
    ...
    function o(t, i) {
        if (i instanceof e.Overlay)
            return i;
        var n = null;
        if (i.element)
            n = e.getElement(i.element);
        else {
    ...
    function d(t) {
        ...
        if (i.preventDefaultAction || t.ctrl || t.alt || t.meta)
            return !0;
        switch (t.keyCode) {
            case 38:
    ...
    function R(t) {
        ...
        if ((o = e.now()) - this._lastScrollTime > this.minScrollDeltaTime) {
            ...
            if (i && i.scrollToZoom)
                return !1
        } else if ((i = this.gestureSettingsByDeviceType(t.pointerType)) && i.scrollToZoom)
            return !1
    }
    function _(e) {
...
!function (e) {
    ...
    e.extend(e, {
        getString: function (i) {
            var n, o = i.split("."), r = null, s = arguments, a = t;
...
!function (e) {
        ...
        getImageInfo: function (t) {
            ...
            if (t.match(/\.js$/)) {
                ...
                e.makeAjaxRequest({
                    ...
                    success: function (t) {
                        var i = function (t) {
                            var i, n, o = t.responseText, r = t.status;
                            {
                                if (!t)
                                    throw new Error(e.getString("Error.Security"));
                                if (200 !== t.status && 0 !== t.status) {
                                    r = t.status;
                                    i = 404 == r ? "Not Found" : t.statusText;
                                    throw new Error(e.getString("Error.Status", r, i))
                                }
                            }
                            if (o.match(/\s*<.*/))
                                try {
    ...
    e.TileSource.determineType = function (t, i, n) {
        ...
        for (o in OpenSeadragon)
            if (o.match(/.+TileSource$/) && e.isFunction(OpenSeadragon[o]) && e.isFunction(OpenSeadragon[o].prototype.supports) && OpenSeadragon[o].prototype.supports.call(t, i, n))
...
!function (e) {
        ...
        configure: function (i, n) {
            ...
            o = e.isPlainObject(i) ? t(this, i) : function (i, n) {
                if (!n || !n.documentElement)
                    throw new Error(e.getString("Error.Xml"));
                var o, r, s, a, l, h = n.documentElement, c = h.localName || h.tagName, u = n.documentElement.namespaceURI, d = null, p = [];
                if ("Image" == c)
                    try {
                        ...
                        if (!e.imageFormatSupported(d.Image.Format))
                            throw new Error(e.getString("Error.ImageFormat", d.Image.Format.toUpperCase()));
                        ...
                        throw t instanceof Error ? t : new Error(e.getString("Error.Dzi"))
                    }
                else {
                    if ("Collection" == c)
                        throw new Error(e.getString("Error.Dzc"));
                    if ("Error" == c) {
                ...
                throw new Error(e.getString("Error.Dzi"))
            }(this, i);
            if (n && !o.tilesUrl) {
    ...
    function t(t, i) {
        var n, o, r = i.Image, s = r.Url, a = r.Format, l = r.Size, h = r.DisplayRect || [], c = parseInt(l.Width, 10), u = parseInt(l.Height, 10), d = parseInt(r.TileSize, 10), p = parseInt(r.Overlap, 10), g = [];
...
!function (e) {
    e.IIIFTileSource = function (t) {
        ...
        if (this.tile_width && this.tile_height) {
            ...
            t.tileSize = this.tile_width;
        else if (this.tile_height)
            t.tileSize = this.tile_height;
        else if (this.tiles)
            ...
            -1 == ["http://library.stanford.edu/iiif/image-api/compliance.html#level0", "http://library.stanford.edu/iiif/image-api/1.1/compliance.html#level0", "http://iiif.io/api/image/2/level0.json"].indexOf(h[0]) || -1 != h.indexOf("sizeByW")) {
    ...
    e.extend(e.IIIFTileSource.prototype, e.TileSource.prototype, {
            ...
            var n = function (t) {
                ...
                if ("info" == i.tagName)
                    try {
                        ...
                        throw t instanceof Error ? t : new Error(e.getString("Error.IIIF"))
                    }
                throw new Error(e.getString("Error.IIIF"))
            }(t);
        ...
        getTileUrl: function (e, t, i) {
            ...
            var o, r, s, a, l, h, c, u, d, p, g, m = Math.pow(.5, this.maxLevel - e), v = Math.ceil(this.width * m), f = Math.ceil(this.height * m);
...
!function (e) {
    e.TmsTileSource = function (t, i, n, o, r) {
        ...
        var a, l = 256 * Math.ceil(s.width / 256), h = 256 * Math.ceil(s.height / 256);
        a = l > h ? l / 256 : h / 256;
    ...
    e.extend(e.LegacyTileSource.prototype, e.TileSource.prototype, {
        ...
        configure: function (i, n) {
            return e.isPlainObject(i) ? t(this, i) : function (i, n) {
                if (!n || !n.documentElement)
                    throw new Error(e.getString("Error.Xml"));
                var o, r, s = n.documentElement, a = s.tagName, l = null, h = [];
                if ("image" == a)
                    try {
                        l = {
...
!function (e) {
    e.ButtonGroup = function (t) {
        ...
        var i, n = this.buttons.concat([]), o = this;
        this.element = t.element || e.makeNeutralElement("div");
        if (!t.group) {
...
!function (e) {
    ...
    e.ReferenceStrip = function (h) {
        var c, u, d, p = h.viewer, g = e.getElementSize(p.element);
        if (!h.id) {
    ...
    e.extend(e.ReferenceStrip.prototype, e.EventSource.prototype, e.Viewer.prototype, {
        setFocus: function (t) {
            var i, n = e.getElement(this.element.id + "-" + t), s = e.getElementSize(this.viewer.canvas), a = Number(this.element.style.width.replace("px", "")), l = Number(this.element.style.height.replace("px", "")), h = -Number(this.element.style.marginLeft.replace("px", "")), c = -Number(this.element.style.marginTop.replace("px", ""));
...
!function (e) {
    ...
    e.Spring.prototype = {
        ...
        update: function () {
            ...
            var n = this.current.time >= this.target.time ? i : t + (i - t) * (o = this.springStiffness,
...
!function (e) {
    ...
    e.Tile.prototype = {
        ...
        drawCanvas: function (t, i, n, o) {
            var r, s = this.position.times(e.pixelDensityRatio), a = this.size.times(e.pixelDensityRatio);
...
!function (e) {
    ...
    e.Overlay.prototype = {
        ...
        _adjustBoundsForRotation: function (t, i) {
            if (!t || 0 === t.degrees || this.rotationMode === e.OverlayRotationMode.EXACT)
                return i;
...
!function (e) {
    ...
    e.Viewport.prototype = {
        ...
        getCenter: function (t) {
            var i, n, o, r, s, a, l = new e.Point(this.centerSpringX.current.value, this.centerSpringY.current.value), h = new e.Point(this.centerSpringX.target.value, this.centerSpringY.target.value);
            if (t)
                return l;
            if (!this.zoomPoint)
                return h;
...
!function (e) {
    ...
    e.extend(e.TiledImage.prototype, e.EventSource.prototype, {
        ...
        _updateViewport: function () {
            ...
            for (var p = h; p >= l; p--) {
                ...
                if (o(this.coverage, p))
                    break
            }
            !function (t, i) {
                if (0 === t.opacity || 0 === i.length && !t.placeholderFillStyle)
                    return;
                var n = i[0];
                var o;
    ...
    function i(t, i, o, a, l, h, c, u, d, p, g, m) {
        ...
        if (v.loaded) {
            ...
            v.loading ? t._tilesLoading++ : w || (m = function (e, t) {
                if (!e)
                    return t;
                {
    ...
    function s(t, i, n, o, r) {
        if (t[i]) {
            ...
            e.console.warn("Setting coverage for a tile before its level's coverage has been reset: %s", i)
    }
    function a(e, t) {
        e[t] = {}
    }
