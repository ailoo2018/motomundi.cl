    ...
    <div class="invoices-header">
      <div class="header-inner">
        <div class="header-title-block">
          <span class="header-eyebrow">Mi cuenta</span>
        ...
        >
          ...
          <div class="card-main">
            ...
            <div class="card-doc">
              ...
              >
                {{ invoice.isCreditNote ? 'NC' : 'BOL' }}
              </div>
              <div class="doc-info">
                <span class="doc-number">#{{ invoice.number }}</span>
                <span class="doc-channel">{{ invoice.facility.name }}</span>
              </div>
            </div>
              ...
              <div class="detail-summary">
                ...
                <div class="summary-rows">
                  <div class="summary-row">
                    ...
                    <span class="summary-value">{{ formatCLP(invoice.totalAfecto) }}</span>
                  </div>
                  <div class="summary-row">
