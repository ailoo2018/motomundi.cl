...
const modalidades = [
  ...
  },
  {
    ...
    icon: '⚡',
    label: 'Click & Collect',
    title: 'Retira dentro de 24 Horas',
    desc: 'Retira tu pedido dentro de 24 horas en la tienda seleccionada (según disponibilidad de stock). El plazo se cuenta desde la apertura de la tienda.',
    badge: 'GRATIS',
    badgeColor: 'green',
  },
  {
