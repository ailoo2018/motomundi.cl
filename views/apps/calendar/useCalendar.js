...
export const useCalendar = (event, isEventHandlerSidebarActive, isLeftSidebarOpen, isViewEventDetail) => {
  ...
  const extractEventDataFromEventApi = eventApi => {
    ...
    console.log("eventApi", JSON.stringify(eventApi))
    const { id, imageUrl, title, start, end, url, eventUrl, extendedProps: { calendar, guests, location, description }, allDay } = eventApi
    ...
    return {
      ...
      id,
      title,
      imageUrl: eventApi.extendedProps.imageUrl,
      imageId: eventApi.extendedProps.imageId,
      eventUrl: eventApi.extendedProps.eventUrl,
      summary: eventApi.extendedProps.summary,
