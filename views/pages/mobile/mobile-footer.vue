        ...
        <div class="col s12 12 footer-container">
          <aside class="footer-description">
            ...
            <p>
              ...
              moto y equipamiento para motociclistas. Contamos con un amplio stock de las mejores marcas en
              indumentaria de carretera y off-road. Nuestra trayectoria y la confianza de fabricantes líderes
              garantizan que compres con la máxima seguridad y respaldo técnico.
            </p>
            ...
            <nav>
              <ul>
                ...
                <!--
                  ...
                  >Twitch</title>
                  <use href="/content/svg/motomundi.svg?v=1.4#i-sm-twitch"
...
.home select {
  border-radius: 3px;
  background: #fff url(/content/images/select-icon@2x.png) no-repeat 100%;
...
@media only screen and (max-width: 992px) {
  .footer-description .motomundi-logo {
    justify-content: center;
  }
}
