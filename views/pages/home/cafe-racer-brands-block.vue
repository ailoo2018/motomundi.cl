...
// Breakpoints must be passed as a stringified JSON object for Web Components
...
<template>
  <div
    ...
    ng-non-bindable
  >
    <aside section="home" class="brands-block"  >
      <div class="container">
        <div class="row">
              ...
              <ClientOnly>
                ...
                >
                  <swiper-slide class="brand swiper-slide swiper-slide-prev">
                    <img
                      class="background"
                      src="/content/images/brands-bg/johndoe_bg.png"
                      loading="lazy"
                    >
                    <h3>
                      <a href="/johndoe">
                  ...
                  <swiper-slide class="brand swiper-slide swiper-slide-prev">
                    <img
                      class="background"
                      src="/content/images/brands-bg/torc_bg.png"
                      loading="lazy"
                    >
                    <h3>
                      <a href="/torc">
                        <img
                          class="logo"
                          src="/content/assets/logos/logo-torc.svg"
                          alt="fox"
                          loading="lazy"
                        >
                      </a>
                  ...
                  <swiper-slide class="brand swiper-slide swiper-slide-prev">
                    <img
                      class="background"
                      src="/content/images/brands-bg/arai_bg.png"
                      loading="lazy"
                    >
                    <h3>
                      <a href="/cascos-arai-cafe-racer">
                        <img
                          class="logo"
                          src="/content/assets/logos/logo-arai.svg"
                          alt="leatt"
                          loading="lazy"
                        >
                      </a>
                  ...
                  <swiper-slide class="brand swiper-slide swiper-slide-prev">
                    <img
                      class="background"
                      src="/content/images/brands-bg/bycity_bg.png"
                      loading="lazy"
                    >
                    <h3>
                      <a href="/bycity">
                        <img
                          class="logo"
                          src="/content/assets/logos/logo-bycity.png"
                          alt="airoh"
                          loading="lazy"
                        >
                      </a>
                  ...
                  <swiper-slide class="brand swiper-slide swiper-slide-prev">
                    <img
                      class="background"
                      src="/content/images/brands-bg/fuel_bg.png"
                      loading="lazy"
                    >
                    <h3>
                      <a href="/fuel">
...
<style scoped>
/* Swiper Element creates its own shadow DOM, but you can style the slides normally */
.container {
  max-width: 1280px;
  width: 95%;
  margin: 0px auto;
