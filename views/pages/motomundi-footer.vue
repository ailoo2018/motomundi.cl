        ...
        <div class="footer-nav__block">
          <div class="footer-nav__menu">
            ...
            <ul>
              ...
              <li>
                <NuxtLink
                  to="/intercomunicadores-gps-para-moto"
                  class="mtc-link"
                >
                  Electrónica
                </NuxtLink>
        ...
        <div class="footer-nav__block">
          <div class="footer-nav__menu">
            ...
            <ul>
              ...
              <li>
                <NuxtLink
                  to="/mochilas-y-bolsos-para-moto"
                  class="mtc-link"
                >
                  Bolsas
                </NuxtLink>
        ...
        <div class="footer-nav__block">
          <div class="footer-nav__menu">
            ...
            <ul>
              ...
              <li>
                <NuxtLink
                  to="/lubricantes-y-fluidos-para-motos"
                  class="mtc-link"
                >
                  Aceites y sprays
                </NuxtLink>
      ...
      <div class="row">
        <div class="col s12 12 footer-container">
          <aside class="footer-description">
            ...
            <p>
              En la nueva web Motomundi.cl encontrarás el mayor stock en
              venta online de accesorios y equipación para moto. Nuestra máxima garantía es la
              confianza que han depositado en nosotros las mejores marcas de equipación de
            ...
            <nav>
              <ul>
                ...
                <li>
                  <NuxtLink
                    to="https://facebook.com/motomundi"
                    target="_blank"
                    rel="noopener"
                    class="sm-fb"
                  >
                ...
                <li>
                  <NuxtLink
                    to="https://twitter.com/motomundi?"
                    target="_blank"
                    rel="noopener"
                    class="sm-tw"
                  >
                ...
                <li>
                  <NuxtLink
                    to="https://www.youtube.com/MotoMundiTv"
                    target="_blank"
                    rel="noopener"
                    class="sm-yt"
                  >
                ...
                <li>
                  <NuxtLink
                    to="https://www.instagram.com/motomundi/"
                    target="_blank"
                    rel="noopener"
                    class="sm-ig"
                  >
                ...
                <li>
                  <NuxtLink
                    to="https://www.tiktok.com/@motomundicl?"
                    target="_blank"
                    rel="noopener"
                    class="sm-tt"
                  >
            ...
            <div class="footer-nav__block">
              <div class="footer-nav__menu">
                ...
                <ul>
                  ...
                  <li>
                    <NuxtLink
                      to="/14963-politicas-comerciales-de-cambio-y-devoluciones"
                      rel="nofollow"
                      class="mtc-link"
                    >
