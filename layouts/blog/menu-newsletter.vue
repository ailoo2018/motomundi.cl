...
<template>
  <nav id="blognav">
    <ul class="categories-menu" ng-controller="BlogSearchCtrl">
      <li>

        <form role="search" method="get" class="search-form blog-search-form">
          <label class="v-select">
            <input type="search"
                   class="input-magnifying-glass search-field not-found-input"
                   value=""
                   name="s"
                   ng-keydown="handleKeyDown($event, searchSelector)"
                   ng-model="sword"
                   data-swplive="true"
            ...
            <ul id="vs1__listbox"
                role="listbox"
                tabindex="-1"
                class="vs__dropdown-menu fade ng-hide"

                ng-class="searchSelector.isShow ? 'ng-show' : ''"
                ng-show="searchSelector.isShow">
              <li
                ng-click="onSelectEntry(entry)"
                id="vs1__option-0"
                role="option"
                ng-mouseenter="entrySelector.index = $index"
                ng-repeat="entry in entries"
                ng-class="{'vs__dropdown-option--highlight' : searchSelector.index == $index}"
                class="blogsearch_dropdown_option vs__dropdown-option">
                {{entry.title}}
              </li>
            </ul>
          </label>
      ...
      <li class="submenu-content">
        <a class="main-category" href="/moto-blog/videos/">
          <div class="icon-container">
            <img
              src="/Content/images/assets/icons/video.svg"
              class="lazyloaded" data-ll-status="loaded">
            <noscript>
  ...
  <div class="subscribe-rss-container">
    <div class="newsletter-container"><p class="sidebar-title">Mantente informado</p>
      <p class="claim">Recibe toda la información sobre la equipación de moto en tu
        correo:</p>
      <form class="newsletter-form subscribe-blog">
        <div class="input-container"><input class="input-email email" type="email"
                                            placeholder="Tu correo electrónico...">
          <button class="submit" data-style="zoom-in">Suscríbete</button>
        </div>
        <div class="error-email ng-hide"> Necesitas un email válido para
          subscribirte
        </div>
        <div class="success ng-hide"><i class="icon-ok"></i> <span class="comment">¡Gracias por apuntarte a nuestra newsletter!</span>
        </div>
        <div class="error-gdpr ng-hide" style="color: #c74044; margin: 10px 0;"><i
          class="icon-attention"></i> Debes aceptar las condiciones antes de
          continuar
        </div>
        <input type="checkbox" id="gdpr-legal-accept-blog-sidebar"
               name="gdpr-legal-accept" class="mc-checkbox"
               ng-model="formData.termsAccepted"> <label
        class="mc-checkbox-label sidebar-gdrp"
        for="gdpr-legal-accept-blog-sidebar"> <span
        class="checkbox-block"></span> He leído y acepto la política de
        privacidad. </label>
        <p class="gdpr-small-newsletter" style="font-size: 10px"> Los datos
          personales que nos facilitas serán tratados por MotoMundi S.P.A.
          ...
          información consulta nuestra <a
            ...
            target="_blank">política de privacidad.</a></p>             <a
        gdpr-more-info=""
        style="text-transform: uppercase;font-size: 11px;margin-top: 5px;display: block;">Más
        información</a></form>
    </div>
    <div class="follow-us-container"><p class="title">O síguenos en tus redes sociales
      favoritas:</p>
      <ul>
        <li><a target="_blank" rel="nofollow"
               href="https://twitter.com/motomundi?lang=es"> <img
        ...
        <li><a target="_blank" rel="nofollow"
               href="https://es-es.facebook.com/motomundi.la/"> <img
        ...
        <li><a target="_blank" rel="nofollow"
               href="https://www.youtube.com/user/motomunditv"> <img
        ...
        <li><a target="_blank" rel="nofollow"
               href="https://www.instagram.com/motomundi/"> <img
